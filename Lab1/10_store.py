...
soft_cost = (store[goods['Диван']][0]['quantity'] * store[goods['Диван']][0]['price']) + (store[goods['Диван']][1]['quantity'] * store[goods['Диван']][1]['price'])
...
soft_quantity = store[goods['Диван']][0]['quantity'] + store[goods['Диван']][1]['quantity']
